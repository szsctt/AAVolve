...
class TestPrintFractionNtReadsPass:
    def test_print_fraction_nt_reads_pass(self, example_dfs, capsys):
        ...
        # check the output
        pass_frac = df_exp[df_exp['File type'] == "Filtered non-parental variants"]['Fraction of reads'].to_list()[0]
